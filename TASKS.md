...
- [ ] Stale food in OFFHAND eaten via right-click — same eat path as main hand? givespoiled stale carrot to offhand, debug use, verify penalty applied (route coverage: every route to the same action).
