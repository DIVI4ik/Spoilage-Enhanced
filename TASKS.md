...
- [ ] Foreign food on the ground (pack deployed): summon a croptopia:tomato item entity with a stale_expirations component on grass, forceload the chunk, wait 15s, read back — does the ItemEntity.tick hook age foreign food on the ground the same as vanilla? Vanilla apple control beside it.
