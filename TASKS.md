...
- [ ] BlockSpoilageData.java:586 — age = currentTime - legacyBirthTime; LEGACY_NEVER is Long.MIN_VALUE and the comment says the subtraction overflows to huge positive. Verify the guard at :572 actually catches it before :586 runs (read the control flow, not just the comment).
