...
- [ ] L13 follow-up on the item-frame finding: PLAYER_REPORTS.md §9 recommends aging frames like armor stands. If the design answer is yes, implement ItemFrameMixin ticking the held stack at the 20-tick cadence (same pattern as ItemMixin.onInventoryTick). Do NOT ship without the design decision — it is recorded as a question.
