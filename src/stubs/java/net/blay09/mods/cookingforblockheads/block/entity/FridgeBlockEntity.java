 ...
 * exactly, and {@code FridgeBlockEntity.serverTick} takes this type as its fourth parameter
 ...
 */
public abstract class FridgeBlockEntity extends BlockEntity {

    protected FridgeBlockEntity(BlockPos pos, BlockState state) {
